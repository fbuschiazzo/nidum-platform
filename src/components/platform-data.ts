...
export const opportunities = [
  {
    ...
    beginnerLabel: "Mejor para empezar",
    bestFor: "Quiero cobrar renta con un activo facil de entender.",
    simpleRisk: "Puede haber meses de vacancia o gastos de mantenimiento.",
    exitPlain: "Podrias publicar tu participacion para venta desde el mes 12.",
    payoutPlain: "Renta estimada trimestral cuando el edificio este estabilizado.",
    feeNote: "Nidum cobra administracion sobre la operacion y lo muestra antes de invertir.",
  ...
  },
  {
    ...
    beginnerLabel: "Mas plazo, renta comercial",
    bestFor: "Puedo dejar la plata mas tiempo y quiero contratos comerciales.",
    simpleRisk: "Depende de conseguir y mantener buenos inquilinos comerciales.",
    exitPlain: "La salida depende de encontrar compradores en el mercado secundario.",
    payoutPlain: "Pagos estimados semestrales una vez alquilada la nave.",
    feeNote: "Los costos de mantenimiento y administracion se descuentan antes de distribuir.",
  ...
  },
  {
    ...
    beginnerLabel: "Mayor retorno potencial",
    bestFor: "Acepto estacionalidad si puedo buscar un retorno mayor.",
    simpleRisk: "La renta depende de temporada, ocupacion y precios diarios.",
    exitPlain: "La salida se habilita despues de la temporada para ordenar valuaciones.",
    payoutPlain: "Distribuciones por temporada, no necesariamente todos los meses.",
    feeNote: "La gestion hotelera y limpieza impactan el flujo neto distribuible.",
